...
n = 5;                   % number of encounter-samples desired           
all_data = cell(n, 6) ;   % collects data from each encounter-sample
adress = string('DAFEA, X, danger_FEA, danger_max_EA, n pure coll., n impure coll.')
